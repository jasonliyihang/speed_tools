...
import com.example.yinlianpay.R;
...
public abstract class BaseActivity extends Activity implements Callback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        insertTN= (EditText) findViewById(R.id.insertTN);

        Button btn0 = (Button) findViewById(R.id.payBtn);
        btn0.setTag(0);
    ...
    public boolean handleMessage(Message msg) {
        ...
        if (msg.obj == null || ((String) msg.obj).length() == 0) {
            ...
            tn = (String) msg.obj;
//            tn = insertTN.getText().toString();
            if (TextUtils.isEmpty(tn)){
                Toast.makeText(getApplicationContext(), "没有TN", Toast.LENGTH_LONG).show();
                return false;
            }
            /*************************************************
             * 步骤2：通过银联工具类启动支付插件
